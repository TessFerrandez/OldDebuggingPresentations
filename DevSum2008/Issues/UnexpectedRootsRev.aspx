...
<script runat="server">
    ...
    public static void OnRemove(string key, Object value, System.Web.Caching.CacheItemRemovedReason reason)
    {
    ...
    protected void btnRun_Click(object sender, EventArgs e)
    {
        ...
        Cache.Add(Guid.NewGuid().ToString(), "smallstring", null, DateTime.Now.AddMinutes(5), TimeSpan.Zero, System.Web.Caching.CacheItemPriority.Normal, OnRemove);
...
<asp:Content ID="TitleContent" ContentPlaceHolderID="Title" runat="server">
	...
	<asp:Content ID="MainContent" ContentPlaceHolderID="MainTable" runat="server">
			...
			<table style="width:90%;text-align:left;font-size:x-large">
				...
				<tr>
					<td>.NET Memory:</td>
					<td style="text-align:right">
						<asp:Literal runat="server" id="lblNetMem" Text="0"></asp:Literal>
						&nbsp;MB
					</td>
				</tr>
				<tr>
					<td>Private Bytes:</td>
					<td style="text-align:right">
						<asp:Literal runat="server" id="lblPrivateBytes" Text="0"></asp:Literal>
						&nbsp;MB
					</td>
				</tr>
				<tr>
					<td>VirtualBytes:</td>
					<td style="text-align:right">
						<asp:Literal runat="server" id="lblVirtualBytes" Text="0"></asp:Literal>
						&nbsp;MB
					</td>
				</tr>
				<tr>
	...
	<asp:Content ContentPlaceHolderID="CodeLink" id="codelinkicon" runat="server">
		<a href="../Code/MemoryRev-Code.htm"><img src="../Images/Code-256x256.png" width="40px" height="40px"/></a>
	</asp:Content>